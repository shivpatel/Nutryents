...
var xValue = function(d) { return d[x];}, // data -> values
    ...
    circleValue = function(d) { return (+d[circle]); },
...
var tooltip = d3.select(".visual-one").append("div")
    .attr("class", "tooltip")
    .style("opacity", 0);
  ...
  svg.selectAll(".dot")
    ...
    .enter().append("circle")
      ...
      .on("mouseover", function(d) {
          $('.visual-one-info').html("<div class=\"details\"> Name: " + d["name"] + "<br/>"+ x + ": " + xValue(d) + "<br>" + y + ":" + yValue(d) + "<br>" + circle + ": " + circleValue(d) + "</div>");
      })
